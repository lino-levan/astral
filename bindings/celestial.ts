...
// Last generated at 2023-07-28T17:16:55.460Z
...
interface Accessibility_loadComplete {
  /**
...
class Accessibility_loadCompleteEvent
  extends CustomEvent<Accessibility_loadComplete> {
  constructor(detail: Accessibility_loadComplete) {
    super("Accessibility_loadComplete", { detail });
  }
}

interface Accessibility_nodesUpdated {
  /**
   * Updated node data.
   */
...
class Accessibility_nodesUpdatedEvent
  extends CustomEvent<Accessibility_nodesUpdated> {
  constructor(detail: Accessibility_nodesUpdated) {
    super("Accessibility_nodesUpdated", { detail });
  }
}

interface Animation_animationCanceled {
  /**
...
class Animation_animationCanceledEvent
  extends CustomEvent<Animation_animationCanceled> {
  constructor(detail: Animation_animationCanceled) {
    super("Animation_animationCanceled", { detail });
  }
}

interface Animation_animationCreated {
  /**
...
class Animation_animationCreatedEvent
  extends CustomEvent<Animation_animationCreated> {
  constructor(detail: Animation_animationCreated) {
    super("Animation_animationCreated", { detail });
  }
}

interface Animation_animationStarted {
  /**
...
class Animation_animationStartedEvent
  extends CustomEvent<Animation_animationStarted> {
  constructor(detail: Animation_animationStarted) {
    super("Animation_animationStarted", { detail });
  }
}

interface Audits_issueAdded {
  issue: Audits_InspectorIssue;
}

class Audits_issueAddedEvent extends CustomEvent<Audits_issueAdded> {
  constructor(detail: Audits_issueAdded) {
    super("Audits_issueAdded", { detail });
  }
}

interface BackgroundService_recordingStateChanged {
  isRecording: boolean;
  service: BackgroundService_ServiceName;
}

class BackgroundService_recordingStateChangedEvent
  extends CustomEvent<BackgroundService_recordingStateChanged> {
  constructor(detail: BackgroundService_recordingStateChanged) {
    super("BackgroundService_recordingStateChanged", { detail });
  }
}

interface BackgroundService_backgroundServiceEventReceived {
  backgroundServiceEvent: BackgroundService_BackgroundServiceEvent;
}

class BackgroundService_backgroundServiceEventReceivedEvent
  ...
  constructor(detail: BackgroundService_backgroundServiceEventReceived) {
    super("BackgroundService_backgroundServiceEventReceived", { detail });
  }
}

interface Browser_downloadWillBegin {
  /**
...
class Browser_downloadProgressEvent
  extends CustomEvent<Browser_downloadProgress> {
  constructor(detail: Browser_downloadProgress) {
    super("Browser_downloadProgress", { detail });
  }
}

interface CSS_fontsUpdated {
  /**
...
class CSS_fontsUpdatedEvent extends CustomEvent<CSS_fontsUpdated> {
  constructor(detail: CSS_fontsUpdated) {
    super("CSS_fontsUpdated", { detail });
  }
}

interface CSS_styleSheetAdded {
  /**
...
class CSS_styleSheetAddedEvent extends CustomEvent<CSS_styleSheetAdded> {
  constructor(detail: CSS_styleSheetAdded) {
    super("CSS_styleSheetAdded", { detail });
  }
}

interface CSS_styleSheetChanged {
  styleSheetId: CSS_StyleSheetId;
}

class CSS_styleSheetChangedEvent extends CustomEvent<CSS_styleSheetChanged> {
  constructor(detail: CSS_styleSheetChanged) {
    super("CSS_styleSheetChanged", { detail });
  }
}

interface CSS_styleSheetRemoved {
  /**
...
class CSS_styleSheetRemovedEvent extends CustomEvent<CSS_styleSheetRemoved> {
  constructor(detail: CSS_styleSheetRemoved) {
    super("CSS_styleSheetRemoved", { detail });
  }
}

interface Cast_sinksUpdated {
  sinks: Cast_Sink[];
}

class Cast_sinksUpdatedEvent extends CustomEvent<Cast_sinksUpdated> {
  constructor(detail: Cast_sinksUpdated) {
    super("Cast_sinksUpdated", { detail });
  }
}

interface Cast_issueUpdated {
  issueMessage: string;
}

class Cast_issueUpdatedEvent extends CustomEvent<Cast_issueUpdated> {
  constructor(detail: Cast_issueUpdated) {
    super("Cast_issueUpdated", { detail });
  }
}

interface DOM_attributeModified {
  /**
...
class DOM_attributeModifiedEvent extends CustomEvent<DOM_attributeModified> {
  constructor(detail: DOM_attributeModified) {
    super("DOM_attributeModified", { detail });
  }
}

interface DOM_attributeRemoved {
  /**
   * Id of the node that has changed.
   */
  nodeId: DOM_NodeId;
...
class DOM_attributeRemovedEvent extends CustomEvent<DOM_attributeRemoved> {
  constructor(detail: DOM_attributeRemoved) {
    super("DOM_attributeRemoved", { detail });
  }
}

interface DOM_characterDataModified {
  /**
   * Id of the node that has changed.
   */
  nodeId: DOM_NodeId;
...
class DOM_childNodeCountUpdatedEvent
  extends CustomEvent<DOM_childNodeCountUpdated> {
  constructor(detail: DOM_childNodeCountUpdated) {
    super("DOM_childNodeCountUpdated", { detail });
  }
}

interface DOM_childNodeInserted {
  /**
   * Id of the node that has changed.
   */
...
class DOM_childNodeInsertedEvent extends CustomEvent<DOM_childNodeInserted> {
  constructor(detail: DOM_childNodeInserted) {
    super("DOM_childNodeInserted", { detail });
  }
}
...
class DOM_childNodeRemovedEvent extends CustomEvent<DOM_childNodeRemoved> {
  constructor(detail: DOM_childNodeRemoved) {
    super("DOM_childNodeRemoved", { detail });
  }
}

interface DOM_distributedNodesUpdated {
  /**
...
class DOM_distributedNodesUpdatedEvent
  extends CustomEvent<DOM_distributedNodesUpdated> {
  constructor(detail: DOM_distributedNodesUpdated) {
    super("DOM_distributedNodesUpdated", { detail });
  }
}

interface DOM_inlineStyleInvalidated {
  /**
...
class DOM_inlineStyleInvalidatedEvent
  extends CustomEvent<DOM_inlineStyleInvalidated> {
  constructor(detail: DOM_inlineStyleInvalidated) {
    super("DOM_inlineStyleInvalidated", { detail });
  }
}

interface DOM_pseudoElementAdded {
  /**
...
class DOM_pseudoElementAddedEvent extends CustomEvent<DOM_pseudoElementAdded> {
  constructor(detail: DOM_pseudoElementAdded) {
    super("DOM_pseudoElementAdded", { detail });
  }
}
...
class DOM_setChildNodesEvent extends CustomEvent<DOM_setChildNodes> {
  constructor(detail: DOM_setChildNodes) {
    super("DOM_setChildNodes", { detail });
  }
}
...
class DOM_shadowRootPoppedEvent extends CustomEvent<DOM_shadowRootPopped> {
  constructor(detail: DOM_shadowRootPopped) {
    super("DOM_shadowRootPopped", { detail });
  }
}

interface DOM_shadowRootPushed {
  /**
   * Host element id.
   */
  hostId: DOM_NodeId;
...
class DOM_shadowRootPushedEvent extends CustomEvent<DOM_shadowRootPushed> {
  constructor(detail: DOM_shadowRootPushed) {
    super("DOM_shadowRootPushed", { detail });
  }
}

interface DOMStorage_domStorageItemAdded {
  storageId: DOMStorage_StorageId;
  key: string;
  newValue: string;
}

class DOMStorage_domStorageItemAddedEvent
  extends CustomEvent<DOMStorage_domStorageItemAdded> {
  constructor(detail: DOMStorage_domStorageItemAdded) {
    super("DOMStorage_domStorageItemAdded", { detail });
  }
}

interface DOMStorage_domStorageItemRemoved {
  storageId: DOMStorage_StorageId;
  key: string;
}

class DOMStorage_domStorageItemRemovedEvent
  extends CustomEvent<DOMStorage_domStorageItemRemoved> {
  constructor(detail: DOMStorage_domStorageItemRemoved) {
    super("DOMStorage_domStorageItemRemoved", { detail });
  }
}

interface DOMStorage_domStorageItemUpdated {
  storageId: DOMStorage_StorageId;
  key: string;
  oldValue: string;
  newValue: string;
...
class DOMStorage_domStorageItemUpdatedEvent
  extends CustomEvent<DOMStorage_domStorageItemUpdated> {
  constructor(detail: DOMStorage_domStorageItemUpdated) {
    super("DOMStorage_domStorageItemUpdated", { detail });
  }
}

interface DOMStorage_domStorageItemsCleared {
  storageId: DOMStorage_StorageId;
}

class DOMStorage_domStorageItemsClearedEvent
  extends CustomEvent<DOMStorage_domStorageItemsCleared> {
  constructor(detail: DOMStorage_domStorageItemsCleared) {
    super("DOMStorage_domStorageItemsCleared", { detail });
  }
}

interface Database_addDatabase {
  database: Database_Database;
}

class Database_addDatabaseEvent extends CustomEvent<Database_addDatabase> {
  constructor(detail: Database_addDatabase) {
    super("Database_addDatabase", { detail });
  }
}

interface Input_dragIntercepted {
  data: Input_DragData;
}

class Input_dragInterceptedEvent extends CustomEvent<Input_dragIntercepted> {
  constructor(detail: Input_dragIntercepted) {
    super("Input_dragIntercepted", { detail });
  }
}

interface Inspector_detached {
  /**
...
class Inspector_detachedEvent extends CustomEvent<Inspector_detached> {
  constructor(detail: Inspector_detached) {
    super("Inspector_detached", { detail });
  }
}

interface LayerTree_layerPainted {
  /**
...
class LayerTree_layerPaintedEvent extends CustomEvent<LayerTree_layerPainted> {
  constructor(detail: LayerTree_layerPainted) {
    super("LayerTree_layerPainted", { detail });
  }
}

interface LayerTree_layerTreeDidChange {
  /**
...
class LayerTree_layerTreeDidChangeEvent
  extends CustomEvent<LayerTree_layerTreeDidChange> {
  constructor(detail: LayerTree_layerTreeDidChange) {
    super("LayerTree_layerTreeDidChange", { detail });
  }
}

interface Log_entryAdded {
  /**
   * The entry.
   */
  entry: Log_LogEntry;
...
class Log_entryAddedEvent extends CustomEvent<Log_entryAdded> {
  constructor(detail: Log_entryAdded) {
    super("Log_entryAdded", { detail });
  }
}

interface Network_dataReceived {
  /**
   * Request identifier.
   */
  requestId: Network_RequestId;
...
class Network_dataReceivedEvent extends CustomEvent<Network_dataReceived> {
  constructor(detail: Network_dataReceived) {
    super("Network_dataReceived", { detail });
  }
}

interface Network_eventSourceMessageReceived {
  /**
   * Request identifier.
   */
  requestId: Network_RequestId;
...
class Network_eventSourceMessageReceivedEvent
  ...
  constructor(detail: Network_eventSourceMessageReceived) {
    super("Network_eventSourceMessageReceived", { detail });
  }
}
...
class Network_loadingFailedEvent extends CustomEvent<Network_loadingFailed> {
  constructor(detail: Network_loadingFailed) {
    super("Network_loadingFailed", { detail });
  }
}

interface Network_loadingFinished {
  /**
   * Request identifier.
   */
  requestId: Network_RequestId;
...
class Network_requestInterceptedEvent
  extends CustomEvent<Network_requestIntercepted> {
  constructor(detail: Network_requestIntercepted) {
    super("Network_requestIntercepted", { detail });
  }
}

interface Network_requestServedFromCache {
  /**
   * Request identifier.
   */
  requestId: Network_RequestId;
...
class Network_requestServedFromCacheEvent
  extends CustomEvent<Network_requestServedFromCache> {
  constructor(detail: Network_requestServedFromCache) {
    super("Network_requestServedFromCache", { detail });
  }
}

interface Network_requestWillBeSent {
  /**
   * Request identifier.
   */
  requestId: Network_RequestId;
...
class Network_requestWillBeSentEvent
  extends CustomEvent<Network_requestWillBeSent> {
  constructor(detail: Network_requestWillBeSent) {
    super("Network_requestWillBeSent", { detail });
  }
}

interface Network_resourceChangedPriority {
  /**
   * Request identifier.
   */
  requestId: Network_RequestId;
...
class Network_resourceChangedPriorityEvent
  extends CustomEvent<Network_resourceChangedPriority> {
  constructor(detail: Network_resourceChangedPriority) {
    super("Network_resourceChangedPriority", { detail });
  }
}

interface Network_signedExchangeReceived {
  /**
   * Request identifier.
   */
  requestId: Network_RequestId;
...
class Network_signedExchangeReceivedEvent
  extends CustomEvent<Network_signedExchangeReceived> {
  constructor(detail: Network_signedExchangeReceived) {
    super("Network_signedExchangeReceived", { detail });
  }
}

interface Network_responseReceived {
  /**
   * Request identifier.
   */
  requestId: Network_RequestId;
...
class Network_responseReceivedEvent
  extends CustomEvent<Network_responseReceived> {
  constructor(detail: Network_responseReceived) {
    super("Network_responseReceived", { detail });
  }
}

interface Network_webSocketClosed {
  /**
   * Request identifier.
   */
  requestId: Network_RequestId;
...
class Network_webSocketClosedEvent
  extends CustomEvent<Network_webSocketClosed> {
  constructor(detail: Network_webSocketClosed) {
    super("Network_webSocketClosed", { detail });
  }
}

interface Network_webSocketCreated {
  /**
   * Request identifier.
   */
  requestId: Network_RequestId;
...
class Network_webSocketCreatedEvent
  extends CustomEvent<Network_webSocketCreated> {
  constructor(detail: Network_webSocketCreated) {
    super("Network_webSocketCreated", { detail });
  }
}

interface Network_webSocketFrameError {
  /**
   * Request identifier.
   */
  requestId: Network_RequestId;
...
class Network_webSocketFrameErrorEvent
  extends CustomEvent<Network_webSocketFrameError> {
  constructor(detail: Network_webSocketFrameError) {
    super("Network_webSocketFrameError", { detail });
  }
}

interface Network_webSocketFrameReceived {
  /**
   * Request identifier.
   */
  requestId: Network_RequestId;
...
class Network_webSocketFrameReceivedEvent
  extends CustomEvent<Network_webSocketFrameReceived> {
  constructor(detail: Network_webSocketFrameReceived) {
    super("Network_webSocketFrameReceived", { detail });
  }
}

interface Network_webSocketFrameSent {
  /**
   * Request identifier.
   */
  requestId: Network_RequestId;
...
class Network_webSocketFrameSentEvent
  extends CustomEvent<Network_webSocketFrameSent> {
  constructor(detail: Network_webSocketFrameSent) {
    super("Network_webSocketFrameSent", { detail });
  }
}

interface Network_webSocketHandshakeResponseReceived {
  /**
   * Request identifier.
   */
  requestId: Network_RequestId;
...
class Network_webSocketHandshakeResponseReceivedEvent
  ...
  constructor(detail: Network_webSocketHandshakeResponseReceived) {
    super("Network_webSocketHandshakeResponseReceived", { detail });
  }
}
...
class Network_webSocketWillSendHandshakeRequestEvent
  ...
  constructor(detail: Network_webSocketWillSendHandshakeRequest) {
    super("Network_webSocketWillSendHandshakeRequest", { detail });
  }
}

interface Network_webTransportCreated {
  /**
...
class Network_webTransportCreatedEvent
  extends CustomEvent<Network_webTransportCreated> {
  constructor(detail: Network_webTransportCreated) {
    super("Network_webTransportCreated", { detail });
  }
}

interface Network_webTransportConnectionEstablished {
  /**
   * WebTransport identifier.
   */
  transportId: Network_RequestId;
...
class Network_webTransportConnectionEstablishedEvent
  ...
  constructor(detail: Network_webTransportConnectionEstablished) {
    super("Network_webTransportConnectionEstablished", { detail });
  }
}

interface Network_webTransportClosed {
  /**
   * WebTransport identifier.
   */
  transportId: Network_RequestId;
...
class Network_trustTokenOperationDoneEvent
  extends CustomEvent<Network_trustTokenOperationDone> {
  constructor(detail: Network_trustTokenOperationDone) {
    super("Network_trustTokenOperationDone", { detail });
  }
}

interface Network_subresourceWebBundleMetadataReceived {
  /**
...
class Network_subresourceWebBundleMetadataReceivedEvent
  ...
  constructor(detail: Network_subresourceWebBundleMetadataReceived) {
    super("Network_subresourceWebBundleMetadataReceived", { detail });
  }
}

interface Network_subresourceWebBundleMetadataError {
  /**
   * Request identifier. Used to match this information to another event.
   */
  requestId: Network_RequestId;
...
class Network_subresourceWebBundleMetadataErrorEvent
  ...
  constructor(detail: Network_subresourceWebBundleMetadataError) {
    super("Network_subresourceWebBundleMetadataError", { detail });
  }
}

interface Network_subresourceWebBundleInnerResponseParsed {
  /**
...
class Network_subresourceWebBundleInnerResponseParsedEvent
  ...
  constructor(detail: Network_subresourceWebBundleInnerResponseParsed) {
    super("Network_subresourceWebBundleInnerResponseParsed", { detail });
  }
}
...
class Network_subresourceWebBundleInnerResponseErrorEvent
  ...
  constructor(detail: Network_subresourceWebBundleInnerResponseError) {
    super("Network_subresourceWebBundleInnerResponseError", { detail });
  }
}

interface Network_reportingApiReportAdded {
...
class Network_reportingApiReportAddedEvent
  ...
  constructor(detail: Network_reportingApiReportAdded) {
    super("Network_reportingApiReportAdded", { detail });
  }
}

interface Network_reportingApiReportUpdated {
  report: Network_ReportingApiReport;
}
...
class Network_reportingApiReportUpdatedEvent
  ...
  constructor(detail: Network_reportingApiReportUpdated) {
    super("Network_reportingApiReportUpdated", { detail });
  }
}

interface Network_reportingApiEndpointsChangedForOrigin {
  /**
...
class Network_reportingApiEndpointsChangedForOriginEvent
  ...
  constructor(detail: Network_reportingApiEndpointsChangedForOrigin) {
    super("Network_reportingApiEndpointsChangedForOrigin", { detail });
  }
}

interface Overlay_inspectNodeRequested {
  /**
...
class Overlay_inspectNodeRequestedEvent
  extends CustomEvent<Overlay_inspectNodeRequested> {
  constructor(detail: Overlay_inspectNodeRequested) {
    super("Overlay_inspectNodeRequested", { detail });
  }
}

interface Overlay_nodeHighlightRequested {
  nodeId: DOM_NodeId;
}

class Overlay_nodeHighlightRequestedEvent
  extends CustomEvent<Overlay_nodeHighlightRequested> {
  constructor(detail: Overlay_nodeHighlightRequested) {
    super("Overlay_nodeHighlightRequested", { detail });
  }
}

interface Overlay_screenshotRequested {
  /**
...
class Overlay_screenshotRequestedEvent
  extends CustomEvent<Overlay_screenshotRequested> {
  constructor(detail: Overlay_screenshotRequested) {
    super("Overlay_screenshotRequested", { detail });
  }
}

interface Page_domContentEventFired {
  timestamp: Network_MonotonicTime;
}

class Page_domContentEventFiredEvent
  extends CustomEvent<Page_domContentEventFired> {
  constructor(detail: Page_domContentEventFired) {
    super("Page_domContentEventFired", { detail });
  }
}

interface Page_fileChooserOpened {
  /**
   * @experimental
...
class Page_fileChooserOpenedEvent extends CustomEvent<Page_fileChooserOpened> {
  constructor(detail: Page_fileChooserOpened) {
    super("Page_fileChooserOpened", { detail });
  }
}
...
class Page_frameAttachedEvent extends CustomEvent<Page_frameAttached> {
  constructor(detail: Page_frameAttached) {
    super("Page_frameAttached", { detail });
  }
}

interface Page_frameClearedScheduledNavigation {
  /**
...
class Page_frameClearedScheduledNavigationEvent
  extends CustomEvent<Page_frameClearedScheduledNavigation> {
  constructor(detail: Page_frameClearedScheduledNavigation) {
    super("Page_frameClearedScheduledNavigation", { detail });
  }
}

interface Page_frameDetached {
  /**
...
class Page_frameDetachedEvent extends CustomEvent<Page_frameDetached> {
  constructor(detail: Page_frameDetached) {
    super("Page_frameDetached", { detail });
  }
}

interface Page_frameNavigated {
  /**
   * Frame object.
   */
  frame: Page_Frame;
...
class Page_frameNavigatedEvent extends CustomEvent<Page_frameNavigated> {
  constructor(detail: Page_frameNavigated) {
    super("Page_frameNavigated", { detail });
  }
}

interface Page_documentOpened {
  /**
   * Frame object.
   */
  frame: Page_Frame;
...
class Page_documentOpenedEvent extends CustomEvent<Page_documentOpened> {
  constructor(detail: Page_documentOpened) {
    super("Page_documentOpened", { detail });
  }
}
...
class Page_frameRequestedNavigationEvent
  extends CustomEvent<Page_frameRequestedNavigation> {
  constructor(detail: Page_frameRequestedNavigation) {
    super("Page_frameRequestedNavigation", { detail });
  }
}

interface Page_frameScheduledNavigation {
  /**
...
class Page_frameScheduledNavigationEvent
  extends CustomEvent<Page_frameScheduledNavigation> {
  constructor(detail: Page_frameScheduledNavigation) {
    super("Page_frameScheduledNavigation", { detail });
  }
}

interface Page_frameStartedLoading {
  /**
...
class Page_frameStartedLoadingEvent
  extends CustomEvent<Page_frameStartedLoading> {
  constructor(detail: Page_frameStartedLoading) {
    super("Page_frameStartedLoading", { detail });
  }
}

interface Page_frameStoppedLoading {
  /**
...
class Page_downloadWillBeginEvent extends CustomEvent<Page_downloadWillBegin> {
  constructor(detail: Page_downloadWillBegin) {
    super("Page_downloadWillBegin", { detail });
  }
}
...
class Page_downloadProgressEvent extends CustomEvent<Page_downloadProgress> {
  constructor(detail: Page_downloadProgress) {
    super("Page_downloadProgress", { detail });
  }
}
...
class Page_javascriptDialogClosedEvent
  extends CustomEvent<Page_javascriptDialogClosed> {
  constructor(detail: Page_javascriptDialogClosed) {
    super("Page_javascriptDialogClosed", { detail });
  }
}

interface Page_javascriptDialogOpening {
  /**
   * Frame url.
   */
  url: string;
...
class Page_javascriptDialogOpeningEvent
  extends CustomEvent<Page_javascriptDialogOpening> {
  constructor(detail: Page_javascriptDialogOpening) {
    super("Page_javascriptDialogOpening", { detail });
  }
}

interface Page_lifecycleEvent {
  /**
   * Id of the frame.
   */
  frameId: Page_FrameId;
...
class Page_lifecycleEventEvent extends CustomEvent<Page_lifecycleEvent> {
  constructor(detail: Page_lifecycleEvent) {
    super("Page_lifecycleEvent", { detail });
  }
}

interface Page_backForwardCacheNotUsed {
  /**
...
class Page_backForwardCacheNotUsedEvent
  extends CustomEvent<Page_backForwardCacheNotUsed> {
  constructor(detail: Page_backForwardCacheNotUsed) {
    super("Page_backForwardCacheNotUsed", { detail });
  }
}

interface Page_loadEventFired {
  timestamp: Network_MonotonicTime;
}

class Page_loadEventFiredEvent extends CustomEvent<Page_loadEventFired> {
  constructor(detail: Page_loadEventFired) {
    super("Page_loadEventFired", { detail });
  }
}

interface Page_navigatedWithinDocument {
  /**
   * Id of the frame.
   */
  frameId: Page_FrameId;
...
class Page_navigatedWithinDocumentEvent
  extends CustomEvent<Page_navigatedWithinDocument> {
  constructor(detail: Page_navigatedWithinDocument) {
    super("Page_navigatedWithinDocument", { detail });
  }
}

interface Page_screencastFrame {
  /**
...
class Page_screencastFrameEvent extends CustomEvent<Page_screencastFrame> {
  constructor(detail: Page_screencastFrame) {
    super("Page_screencastFrame", { detail });
  }
}
...
class Page_windowOpenEvent extends CustomEvent<Page_windowOpen> {
  constructor(detail: Page_windowOpen) {
    super("Page_windowOpen", { detail });
  }
}

interface Page_compilationCacheProduced {
  url: string;
  /**
   * Base64-encoded data
   */
...
class Performance_metricsEvent extends CustomEvent<Performance_metrics> {
  constructor(detail: Performance_metrics) {
    super("Performance_metrics", { detail });
  }
}

interface PerformanceTimeline_timelineEventAdded {
  event: PerformanceTimeline_TimelineEvent;
}

class PerformanceTimeline_timelineEventAddedEvent
  extends CustomEvent<PerformanceTimeline_timelineEventAdded> {
  constructor(detail: PerformanceTimeline_timelineEventAdded) {
    super("PerformanceTimeline_timelineEventAdded", { detail });
  }
}

interface Security_certificateError {
  /**
   * The ID of the event.
   */
  eventId: number;
...
class Security_certificateErrorEvent
  extends CustomEvent<Security_certificateError> {
  constructor(detail: Security_certificateError) {
    super("Security_certificateError", { detail });
  }
}

interface Security_visibleSecurityStateChanged {
  /**
   * Security state information about the page.
   */
...
class Security_visibleSecurityStateChangedEvent
  extends CustomEvent<Security_visibleSecurityStateChanged> {
  constructor(detail: Security_visibleSecurityStateChanged) {
    super("Security_visibleSecurityStateChanged", { detail });
  }
}

interface Security_securityStateChanged {
  /**
   * Security state.
   */
  securityState: Security_SecurityState;
...
class Storage_cacheStorageContentUpdatedEvent
  extends CustomEvent<Storage_cacheStorageContentUpdated> {
  constructor(detail: Storage_cacheStorageContentUpdated) {
    super("Storage_cacheStorageContentUpdated", { detail });
  }
}

interface Storage_cacheStorageListUpdated {
  /**
   * Origin to update.
   */
  origin: string;
...
class Storage_cacheStorageListUpdatedEvent
  extends CustomEvent<Storage_cacheStorageListUpdated> {
  constructor(detail: Storage_cacheStorageListUpdated) {
    super("Storage_cacheStorageListUpdated", { detail });
  }
}

interface Storage_indexedDBContentUpdated {
  /**
   * Origin to update.
   */
  origin: string;
...
class Storage_indexedDBContentUpdatedEvent
  extends CustomEvent<Storage_indexedDBContentUpdated> {
  constructor(detail: Storage_indexedDBContentUpdated) {
    super("Storage_indexedDBContentUpdated", { detail });
  }
}

interface Storage_indexedDBListUpdated {
  /**
   * Origin to update.
   */
  origin: string;
...
class Storage_indexedDBListUpdatedEvent
  extends CustomEvent<Storage_indexedDBListUpdated> {
  constructor(detail: Storage_indexedDBListUpdated) {
    super("Storage_indexedDBListUpdated", { detail });
  }
}

interface Storage_interestGroupAccessed {
...
class Storage_interestGroupAccessedEvent
  extends CustomEvent<Storage_interestGroupAccessed> {
  constructor(detail: Storage_interestGroupAccessed) {
    super("Storage_interestGroupAccessed", { detail });
  }
}

interface Storage_sharedStorageAccessed {
  /**
   * Time of the access.
   */
  accessTime: Network_TimeSinceEpoch;
...
class Storage_attributionReportingSourceRegisteredEvent
  ...
  constructor(detail: Storage_attributionReportingSourceRegistered) {
    super("Storage_attributionReportingSourceRegistered", { detail });
  }
}

interface Target_attachedToTarget {
  /**
...
class Target_attachedToTargetEvent
  extends CustomEvent<Target_attachedToTarget> {
  constructor(detail: Target_attachedToTarget) {
    super("Target_attachedToTarget", { detail });
  }
}

interface Target_detachedFromTarget {
  /**
...
class Target_detachedFromTargetEvent
  extends CustomEvent<Target_detachedFromTarget> {
  constructor(detail: Target_detachedFromTarget) {
    super("Target_detachedFromTarget", { detail });
  }
}

interface Target_receivedMessageFromTarget {
  /**
...
class Target_receivedMessageFromTargetEvent
  extends CustomEvent<Target_receivedMessageFromTarget> {
  constructor(detail: Target_receivedMessageFromTarget) {
    super("Target_receivedMessageFromTarget", { detail });
  }
}

interface Target_targetCreated {
  targetInfo: Target_TargetInfo;
}

class Target_targetCreatedEvent extends CustomEvent<Target_targetCreated> {
  constructor(detail: Target_targetCreated) {
    super("Target_targetCreated", { detail });
  }
}

interface Target_targetDestroyed {
  targetId: Target_TargetID;
}

class Target_targetDestroyedEvent extends CustomEvent<Target_targetDestroyed> {
  constructor(detail: Target_targetDestroyed) {
    super("Target_targetDestroyed", { detail });
  }
}

interface Target_targetCrashed {
  targetId: Target_TargetID;
  /**
...
class Target_targetCrashedEvent extends CustomEvent<Target_targetCrashed> {
  constructor(detail: Target_targetCrashed) {
    super("Target_targetCrashed", { detail });
  }
}

interface Target_targetInfoChanged {
  targetInfo: Target_TargetInfo;
}

class Target_targetInfoChangedEvent
  extends CustomEvent<Target_targetInfoChanged> {
  constructor(detail: Target_targetInfoChanged) {
    super("Target_targetInfoChanged", { detail });
  }
}

interface Tethering_accepted {
  /**
...
class Tethering_acceptedEvent extends CustomEvent<Tethering_accepted> {
  constructor(detail: Tethering_accepted) {
    super("Tethering_accepted", { detail });
  }
}
...
class Tracing_bufferUsageEvent extends CustomEvent<Tracing_bufferUsage> {
  constructor(detail: Tracing_bufferUsage) {
    super("Tracing_bufferUsage", { detail });
  }
}

interface Tracing_dataCollected {
  value: object[];
}

class Tracing_dataCollectedEvent extends CustomEvent<Tracing_dataCollected> {
  constructor(detail: Tracing_dataCollected) {
    super("Tracing_dataCollected", { detail });
  }
}

interface Tracing_tracingComplete {
  /**
...
class Fetch_requestPausedEvent extends CustomEvent<Fetch_requestPaused> {
  constructor(detail: Fetch_requestPaused) {
    super("Fetch_requestPaused", { detail });
  }
}
...
class Fetch_authRequiredEvent extends CustomEvent<Fetch_authRequired> {
  constructor(detail: Fetch_authRequired) {
    super("Fetch_authRequired", { detail });
  }
}

interface WebAudio_contextCreated {
  context: WebAudio_BaseAudioContext;
}

class WebAudio_contextCreatedEvent
  extends CustomEvent<WebAudio_contextCreated> {
  constructor(detail: WebAudio_contextCreated) {
    super("WebAudio_contextCreated", { detail });
  }
}

interface WebAudio_contextWillBeDestroyed {
  contextId: WebAudio_GraphObjectId;
}

class WebAudio_contextWillBeDestroyedEvent
  extends CustomEvent<WebAudio_contextWillBeDestroyed> {
  constructor(detail: WebAudio_contextWillBeDestroyed) {
    super("WebAudio_contextWillBeDestroyed", { detail });
  }
}

interface WebAudio_contextChanged {
  context: WebAudio_BaseAudioContext;
}

class WebAudio_contextChangedEvent
  extends CustomEvent<WebAudio_contextChanged> {
  constructor(detail: WebAudio_contextChanged) {
    super("WebAudio_contextChanged", { detail });
  }
}

interface WebAudio_audioListenerCreated {
  listener: WebAudio_AudioListener;
}

class WebAudio_audioListenerCreatedEvent
  extends CustomEvent<WebAudio_audioListenerCreated> {
  constructor(detail: WebAudio_audioListenerCreated) {
    super("WebAudio_audioListenerCreated", { detail });
  }
}

interface WebAudio_audioListenerWillBeDestroyed {
  contextId: WebAudio_GraphObjectId;
  listenerId: WebAudio_GraphObjectId;
}

class WebAudio_audioListenerWillBeDestroyedEvent
  extends CustomEvent<WebAudio_audioListenerWillBeDestroyed> {
  constructor(detail: WebAudio_audioListenerWillBeDestroyed) {
    super("WebAudio_audioListenerWillBeDestroyed", { detail });
  }
}

interface WebAudio_audioNodeCreated {
  node: WebAudio_AudioNode;
}

class WebAudio_audioNodeCreatedEvent
  extends CustomEvent<WebAudio_audioNodeCreated> {
  constructor(detail: WebAudio_audioNodeCreated) {
    super("WebAudio_audioNodeCreated", { detail });
  }
}

interface WebAudio_audioNodeWillBeDestroyed {
  contextId: WebAudio_GraphObjectId;
  nodeId: WebAudio_GraphObjectId;
}

class WebAudio_audioNodeWillBeDestroyedEvent
  extends CustomEvent<WebAudio_audioNodeWillBeDestroyed> {
  constructor(detail: WebAudio_audioNodeWillBeDestroyed) {
    super("WebAudio_audioNodeWillBeDestroyed", { detail });
  }
}

interface WebAudio_audioParamCreated {
  param: WebAudio_AudioParam;
}

class WebAudio_audioParamCreatedEvent
  extends CustomEvent<WebAudio_audioParamCreated> {
  constructor(detail: WebAudio_audioParamCreated) {
    super("WebAudio_audioParamCreated", { detail });
  }
}
...
class WebAudio_audioParamWillBeDestroyedEvent
  extends CustomEvent<WebAudio_audioParamWillBeDestroyed> {
  constructor(detail: WebAudio_audioParamWillBeDestroyed) {
    super("WebAudio_audioParamWillBeDestroyed", { detail });
  }
}

interface WebAudio_nodesConnected {
  contextId: WebAudio_GraphObjectId;
...
class WebAudio_nodesConnectedEvent
  extends CustomEvent<WebAudio_nodesConnected> {
  constructor(detail: WebAudio_nodesConnected) {
    super("WebAudio_nodesConnected", { detail });
  }
}

interface WebAudio_nodesDisconnected {
  contextId: WebAudio_GraphObjectId;
  sourceId: WebAudio_GraphObjectId;
  destinationId: WebAudio_GraphObjectId;
  sourceOutputIndex?: number;
...
class WebAudio_nodesDisconnectedEvent
  extends CustomEvent<WebAudio_nodesDisconnected> {
  constructor(detail: WebAudio_nodesDisconnected) {
    super("WebAudio_nodesDisconnected", { detail });
  }
}

interface WebAudio_nodeParamConnected {
  contextId: WebAudio_GraphObjectId;
  sourceId: WebAudio_GraphObjectId;
  destinationId: WebAudio_GraphObjectId;
  sourceOutputIndex?: number;
...
class WebAudio_nodeParamConnectedEvent
  extends CustomEvent<WebAudio_nodeParamConnected> {
  constructor(detail: WebAudio_nodeParamConnected) {
    super("WebAudio_nodeParamConnected", { detail });
  }
}

interface WebAudio_nodeParamDisconnected {
  contextId: WebAudio_GraphObjectId;
  sourceId: WebAudio_GraphObjectId;
  destinationId: WebAudio_GraphObjectId;
  sourceOutputIndex?: number;
...
class Media_playerMessagesLoggedEvent
  ...
  constructor(detail: Media_playerMessagesLogged) {
    super("Media_playerMessagesLogged", { detail });
  }
}

interface Media_playerErrorsRaised {
  playerId: Media_PlayerId;
...
class Media_playerErrorsRaisedEvent
  ...
  constructor(detail: Media_playerErrorsRaised) {
    super("Media_playerErrorsRaised", { detail });
  }
}

interface Media_playersCreated {
  players: Media_PlayerId[];
}

class Media_playersCreatedEvent extends CustomEvent<Media_playersCreated> {
  constructor(detail: Media_playersCreated) {
    super("Media_playersCreated", { detail });
  }
}

interface DeviceAccess_deviceRequestPrompted {
  id: DeviceAccess_RequestId;
  devices: DeviceAccess_PromptDevice[];
}

class DeviceAccess_deviceRequestPromptedEvent
  extends CustomEvent<DeviceAccess_deviceRequestPrompted> {
  constructor(detail: DeviceAccess_deviceRequestPrompted) {
    super("DeviceAccess_deviceRequestPrompted", { detail });
  }
}

interface Preload_ruleSetUpdated {
  ruleSet: Preload_RuleSet;
}

class Preload_ruleSetUpdatedEvent extends CustomEvent<Preload_ruleSetUpdated> {
  constructor(detail: Preload_ruleSetUpdated) {
    super("Preload_ruleSetUpdated", { detail });
  }
}

interface Preload_ruleSetRemoved {
  id: Preload_RuleSetId;
}

class Preload_ruleSetRemovedEvent extends CustomEvent<Preload_ruleSetRemoved> {
  constructor(detail: Preload_ruleSetRemoved) {
    super("Preload_ruleSetRemoved", { detail });
  }
}

interface Preload_prerenderAttemptCompleted {
  key: Preload_PreloadingAttemptKey;
  /**
  ...
  finalStatus: Preload_PrerenderFinalStatus;
  /**
...
class Preload_prerenderAttemptCompletedEvent
  extends CustomEvent<Preload_prerenderAttemptCompleted> {
  constructor(detail: Preload_prerenderAttemptCompleted) {
    super("Preload_prerenderAttemptCompleted", { detail });
  }
}

interface Preload_preloadEnabledStateUpdated {
...
class Preload_preloadEnabledStateUpdatedEvent
  ...
  constructor(detail: Preload_preloadEnabledStateUpdated) {
    super("Preload_preloadEnabledStateUpdated", { detail });
  }
}

interface Preload_prefetchStatusUpdated {
  key: Preload_PreloadingAttemptKey;
  /**
...
class FedCm_dialogShownEvent extends CustomEvent<FedCm_dialogShown> {
  constructor(detail: FedCm_dialogShown) {
    super("FedCm_dialogShown", { detail });
  }
}

interface Console_messageAdded {
  /**
...
class Console_messageAddedEvent extends CustomEvent<Console_messageAdded> {
  constructor(detail: Console_messageAdded) {
    super("Console_messageAdded", { detail });
  }
}

interface Debugger_breakpointResolved {
  /**
...
class Debugger_breakpointResolvedEvent
  extends CustomEvent<Debugger_breakpointResolved> {
  constructor(detail: Debugger_breakpointResolved) {
    super("Debugger_breakpointResolved", { detail });
  }
}

interface Debugger_paused {
  /**
...
class Debugger_pausedEvent extends CustomEvent<Debugger_paused> {
  constructor(detail: Debugger_paused) {
    super("Debugger_paused", { detail });
  }
}

interface Debugger_scriptFailedToParse {
  /**
...
class Debugger_scriptParsedEvent extends CustomEvent<Debugger_scriptParsed> {
  constructor(detail: Debugger_scriptParsed) {
    super("Debugger_scriptParsed", { detail });
  }
}

interface HeapProfiler_addHeapSnapshotChunk {
  chunk: string;
}

class HeapProfiler_addHeapSnapshotChunkEvent
  extends CustomEvent<HeapProfiler_addHeapSnapshotChunk> {
  constructor(detail: HeapProfiler_addHeapSnapshotChunk) {
    super("HeapProfiler_addHeapSnapshotChunk", { detail });
  }
}
...
class HeapProfiler_heapStatsUpdateEvent
  extends CustomEvent<HeapProfiler_heapStatsUpdate> {
  constructor(detail: HeapProfiler_heapStatsUpdate) {
    super("HeapProfiler_heapStatsUpdate", { detail });
  }
}

interface HeapProfiler_lastSeenObjectId {
  lastSeenObjectId: number;
  timestamp: number;
}

class HeapProfiler_lastSeenObjectIdEvent
  extends CustomEvent<HeapProfiler_lastSeenObjectId> {
  constructor(detail: HeapProfiler_lastSeenObjectId) {
    super("HeapProfiler_lastSeenObjectId", { detail });
  }
}

interface HeapProfiler_reportHeapSnapshotProgress {
  done: number;
  total: number;
  finished?: boolean;
}

class HeapProfiler_reportHeapSnapshotProgressEvent
  extends CustomEvent<HeapProfiler_reportHeapSnapshotProgress> {
  constructor(detail: HeapProfiler_reportHeapSnapshotProgress) {
    super("HeapProfiler_reportHeapSnapshotProgress", { detail });
  }
}

interface Profiler_consoleProfileFinished {
  id: string;
  /**
...
class Profiler_consoleProfileFinishedEvent
  ...
  constructor(detail: Profiler_consoleProfileFinished) {
    super("Profiler_consoleProfileFinished", { detail });
  }
}
...
class Profiler_consoleProfileStartedEvent
  ...
  constructor(detail: Profiler_consoleProfileStarted) {
    super("Profiler_consoleProfileStarted", { detail });
  }
}

interface Profiler_preciseCoverageDeltaUpdate {
  /**
...
class Profiler_preciseCoverageDeltaUpdateEvent
  extends CustomEvent<Profiler_preciseCoverageDeltaUpdate> {
  constructor(detail: Profiler_preciseCoverageDeltaUpdate) {
    super("Profiler_preciseCoverageDeltaUpdate", { detail });
  }
}

interface Runtime_bindingCalled {
  name: string;
  payload: string;
  /**
...
class Runtime_bindingCalledEvent extends CustomEvent<Runtime_bindingCalled> {
  constructor(detail: Runtime_bindingCalled) {
    super("Runtime_bindingCalled", { detail });
  }
}
...
class Runtime_exceptionRevokedEvent
  extends CustomEvent<Runtime_exceptionRevoked> {
  constructor(detail: Runtime_exceptionRevoked) {
    super("Runtime_exceptionRevoked", { detail });
  }
}

interface Runtime_exceptionThrown {
  /**
...
class Runtime_exceptionThrownEvent
  extends CustomEvent<Runtime_exceptionThrown> {
  constructor(detail: Runtime_exceptionThrown) {
    super("Runtime_exceptionThrown", { detail });
  }
}

interface Runtime_executionContextCreated {
  /**
...
class Runtime_executionContextCreatedEvent
  extends CustomEvent<Runtime_executionContextCreated> {
  constructor(detail: Runtime_executionContextCreated) {
    super("Runtime_executionContextCreated", { detail });
  }
}

interface Runtime_executionContextDestroyed {
  /**
   * @deprecated
...
class Runtime_executionContextDestroyedEvent
  extends CustomEvent<Runtime_executionContextDestroyed> {
  constructor(detail: Runtime_executionContextDestroyed) {
    super("Runtime_executionContextDestroyed", { detail });
  }
}

interface Runtime_inspectRequested {
  object: Runtime_RemoteObject;
  hints: object;
  /**
   * @experimental
...
class Runtime_inspectRequestedEvent
  extends CustomEvent<Runtime_inspectRequested> {
  constructor(detail: Runtime_inspectRequested) {
    super("Runtime_inspectRequested", { detail });
  }
}

const CelestialEvents = {
  "Accessibility_loadComplete": Accessibility_loadCompleteEvent,
  "Accessibility_nodesUpdated": Accessibility_nodesUpdatedEvent,
  "Animation_animationCanceled": Animation_animationCanceledEvent,
  "Animation_animationCreated": Animation_animationCreatedEvent,
  "Animation_animationStarted": Animation_animationStartedEvent,
  "Audits_issueAdded": Audits_issueAddedEvent,
  "BackgroundService_recordingStateChanged":
    BackgroundService_recordingStateChangedEvent,
  "BackgroundService_backgroundServiceEventReceived":
    BackgroundService_backgroundServiceEventReceivedEvent,
  "Browser_downloadWillBegin": Browser_downloadWillBeginEvent,
  "Browser_downloadProgress": Browser_downloadProgressEvent,
  "CSS_fontsUpdated": CSS_fontsUpdatedEvent,
  "CSS_mediaQueryResultChanged": Event,
  "CSS_styleSheetAdded": CSS_styleSheetAddedEvent,
  "CSS_styleSheetChanged": CSS_styleSheetChangedEvent,
  "CSS_styleSheetRemoved": CSS_styleSheetRemovedEvent,
  "Cast_sinksUpdated": Cast_sinksUpdatedEvent,
  "Cast_issueUpdated": Cast_issueUpdatedEvent,
  "DOM_attributeModified": DOM_attributeModifiedEvent,
  "DOM_attributeRemoved": DOM_attributeRemovedEvent,
  "DOM_characterDataModified": DOM_characterDataModifiedEvent,
  "DOM_childNodeCountUpdated": DOM_childNodeCountUpdatedEvent,
  "DOM_childNodeInserted": DOM_childNodeInsertedEvent,
  "DOM_childNodeRemoved": DOM_childNodeRemovedEvent,
  "DOM_distributedNodesUpdated": DOM_distributedNodesUpdatedEvent,
  "DOM_documentUpdated": Event,
  "DOM_inlineStyleInvalidated": DOM_inlineStyleInvalidatedEvent,
  "DOM_pseudoElementAdded": DOM_pseudoElementAddedEvent,
  "DOM_topLayerElementsUpdated": Event,
  "DOM_pseudoElementRemoved": DOM_pseudoElementRemovedEvent,
  "DOM_setChildNodes": DOM_setChildNodesEvent,
  "DOM_shadowRootPopped": DOM_shadowRootPoppedEvent,
  "DOM_shadowRootPushed": DOM_shadowRootPushedEvent,
  "DOMStorage_domStorageItemAdded": DOMStorage_domStorageItemAddedEvent,
  "DOMStorage_domStorageItemRemoved": DOMStorage_domStorageItemRemovedEvent,
  "DOMStorage_domStorageItemUpdated": DOMStorage_domStorageItemUpdatedEvent,
  "DOMStorage_domStorageItemsCleared": DOMStorage_domStorageItemsClearedEvent,
  "Database_addDatabase": Database_addDatabaseEvent,
  "Emulation_virtualTimeBudgetExpired": Event,
  "Input_dragIntercepted": Input_dragInterceptedEvent,
  "Inspector_detached": Inspector_detachedEvent,
  "Inspector_targetCrashed": Event,
  "Inspector_targetReloadedAfterCrash": Event,
  "LayerTree_layerPainted": LayerTree_layerPaintedEvent,
  "LayerTree_layerTreeDidChange": LayerTree_layerTreeDidChangeEvent,
  "Log_entryAdded": Log_entryAddedEvent,
  "Network_dataReceived": Network_dataReceivedEvent,
  "Network_eventSourceMessageReceived": Network_eventSourceMessageReceivedEvent,
  "Network_loadingFailed": Network_loadingFailedEvent,
  "Network_loadingFinished": Network_loadingFinishedEvent,
  "Network_requestIntercepted": Network_requestInterceptedEvent,
  "Network_requestServedFromCache": Network_requestServedFromCacheEvent,
  "Network_requestWillBeSent": Network_requestWillBeSentEvent,
  "Network_resourceChangedPriority": Network_resourceChangedPriorityEvent,
  "Network_signedExchangeReceived": Network_signedExchangeReceivedEvent,
  "Network_responseReceived": Network_responseReceivedEvent,
  "Network_webSocketClosed": Network_webSocketClosedEvent,
  "Network_webSocketCreated": Network_webSocketCreatedEvent,
  "Network_webSocketFrameError": Network_webSocketFrameErrorEvent,
  "Network_webSocketFrameReceived": Network_webSocketFrameReceivedEvent,
  "Network_webSocketFrameSent": Network_webSocketFrameSentEvent,
  ...
  "Network_webTransportCreated": Network_webTransportCreatedEvent,
  "Network_webTransportConnectionEstablished":
    Network_webTransportConnectionEstablishedEvent,
  "Network_webTransportClosed": Network_webTransportClosedEvent,
  "Network_requestWillBeSentExtraInfo": Network_requestWillBeSentExtraInfoEvent,
  "Network_responseReceivedExtraInfo": Network_responseReceivedExtraInfoEvent,
  "Network_trustTokenOperationDone": Network_trustTokenOperationDoneEvent,
  "Network_subresourceWebBundleMetadataReceived":
    Network_subresourceWebBundleMetadataReceivedEvent,
  "Network_subresourceWebBundleMetadataError":
    Network_subresourceWebBundleMetadataErrorEvent,
  "Network_subresourceWebBundleInnerResponseParsed":
    Network_subresourceWebBundleInnerResponseParsedEvent,
  "Network_subresourceWebBundleInnerResponseError":
    Network_subresourceWebBundleInnerResponseErrorEvent,
  "Network_reportingApiReportAdded": Network_reportingApiReportAddedEvent,
  "Network_reportingApiReportUpdated": Network_reportingApiReportUpdatedEvent,
  "Network_reportingApiEndpointsChangedForOrigin":
    Network_reportingApiEndpointsChangedForOriginEvent,
  "Overlay_inspectNodeRequested": Overlay_inspectNodeRequestedEvent,
  "Overlay_nodeHighlightRequested": Overlay_nodeHighlightRequestedEvent,
  "Overlay_screenshotRequested": Overlay_screenshotRequestedEvent,
  "Overlay_inspectModeCanceled": Event,
  "Page_domContentEventFired": Page_domContentEventFiredEvent,
  "Page_fileChooserOpened": Page_fileChooserOpenedEvent,
  "Page_frameAttached": Page_frameAttachedEvent,
  "Page_frameClearedScheduledNavigation":
    Page_frameClearedScheduledNavigationEvent,
  "Page_frameDetached": Page_frameDetachedEvent,
  "Page_frameNavigated": Page_frameNavigatedEvent,
  "Page_documentOpened": Page_documentOpenedEvent,
  "Page_frameResized": Event,
  "Page_frameRequestedNavigation": Page_frameRequestedNavigationEvent,
  "Page_frameScheduledNavigation": Page_frameScheduledNavigationEvent,
  "Page_frameStartedLoading": Page_frameStartedLoadingEvent,
  "Page_frameStoppedLoading": Page_frameStoppedLoadingEvent,
  "Page_downloadWillBegin": Page_downloadWillBeginEvent,
  "Page_downloadProgress": Page_downloadProgressEvent,
  "Page_interstitialHidden": Event,
  "Page_interstitialShown": Event,
  "Page_javascriptDialogClosed": Page_javascriptDialogClosedEvent,
  "Page_javascriptDialogOpening": Page_javascriptDialogOpeningEvent,
  "Page_lifecycleEvent": Page_lifecycleEventEvent,
  "Page_backForwardCacheNotUsed": Page_backForwardCacheNotUsedEvent,
  "Page_loadEventFired": Page_loadEventFiredEvent,
  "Page_navigatedWithinDocument": Page_navigatedWithinDocumentEvent,
  "Page_screencastFrame": Page_screencastFrameEvent,
  "Page_screencastVisibilityChanged": Page_screencastVisibilityChangedEvent,
  "Page_windowOpen": Page_windowOpenEvent,
  "Page_compilationCacheProduced": Page_compilationCacheProducedEvent,
  "Performance_metrics": Performance_metricsEvent,
  "PerformanceTimeline_timelineEventAdded":
    PerformanceTimeline_timelineEventAddedEvent,
  "Security_certificateError": Security_certificateErrorEvent,
  "Security_visibleSecurityStateChanged":
    Security_visibleSecurityStateChangedEvent,
  "Security_securityStateChanged": Security_securityStateChangedEvent,
  "ServiceWorker_workerErrorReported": ServiceWorker_workerErrorReportedEvent,
  "ServiceWorker_workerRegistrationUpdated":
    ServiceWorker_workerRegistrationUpdatedEvent,
  "ServiceWorker_workerVersionUpdated": ServiceWorker_workerVersionUpdatedEvent,
  "Storage_cacheStorageContentUpdated": Storage_cacheStorageContentUpdatedEvent,
  "Storage_cacheStorageListUpdated": Storage_cacheStorageListUpdatedEvent,
  "Storage_indexedDBContentUpdated": Storage_indexedDBContentUpdatedEvent,
  "Storage_indexedDBListUpdated": Storage_indexedDBListUpdatedEvent,
  "Storage_interestGroupAccessed": Storage_interestGroupAccessedEvent,
  "Storage_sharedStorageAccessed": Storage_sharedStorageAccessedEvent,
  "Storage_storageBucketCreatedOrUpdated":
    Storage_storageBucketCreatedOrUpdatedEvent,
  "Storage_storageBucketDeleted": Storage_storageBucketDeletedEvent,
  "Storage_attributionReportingSourceRegistered":
    Storage_attributionReportingSourceRegisteredEvent,
  "Target_attachedToTarget": Target_attachedToTargetEvent,
  "Target_detachedFromTarget": Target_detachedFromTargetEvent,
  "Target_receivedMessageFromTarget": Target_receivedMessageFromTargetEvent,
  "Target_targetCreated": Target_targetCreatedEvent,
  "Target_targetDestroyed": Target_targetDestroyedEvent,
  "Target_targetCrashed": Target_targetCrashedEvent,
  "Target_targetInfoChanged": Target_targetInfoChangedEvent,
  "Tethering_accepted": Tethering_acceptedEvent,
  "Tracing_bufferUsage": Tracing_bufferUsageEvent,
  "Tracing_dataCollected": Tracing_dataCollectedEvent,
  "Tracing_tracingComplete": Tracing_tracingCompleteEvent,
  "Fetch_requestPaused": Fetch_requestPausedEvent,
  "Fetch_authRequired": Fetch_authRequiredEvent,
  "WebAudio_contextCreated": WebAudio_contextCreatedEvent,
  "WebAudio_contextWillBeDestroyed": WebAudio_contextWillBeDestroyedEvent,
  "WebAudio_contextChanged": WebAudio_contextChangedEvent,
  "WebAudio_audioListenerCreated": WebAudio_audioListenerCreatedEvent,
  "WebAudio_audioListenerWillBeDestroyed":
    WebAudio_audioListenerWillBeDestroyedEvent,
  "WebAudio_audioNodeCreated": WebAudio_audioNodeCreatedEvent,
  "WebAudio_audioNodeWillBeDestroyed": WebAudio_audioNodeWillBeDestroyedEvent,
  "WebAudio_audioParamCreated": WebAudio_audioParamCreatedEvent,
  "WebAudio_audioParamWillBeDestroyed": WebAudio_audioParamWillBeDestroyedEvent,
  "WebAudio_nodesConnected": WebAudio_nodesConnectedEvent,
  "WebAudio_nodesDisconnected": WebAudio_nodesDisconnectedEvent,
  "WebAudio_nodeParamConnected": WebAudio_nodeParamConnectedEvent,
  "WebAudio_nodeParamDisconnected": WebAudio_nodeParamDisconnectedEvent,
  "WebAuthn_credentialAdded": WebAuthn_credentialAddedEvent,
  "WebAuthn_credentialAsserted": WebAuthn_credentialAssertedEvent,
  "Media_playerPropertiesChanged": Media_playerPropertiesChangedEvent,
  "Media_playerEventsAdded": Media_playerEventsAddedEvent,
  "Media_playerMessagesLogged": Media_playerMessagesLoggedEvent,
  "Media_playerErrorsRaised": Media_playerErrorsRaisedEvent,
  "Media_playersCreated": Media_playersCreatedEvent,
  "DeviceAccess_deviceRequestPrompted": DeviceAccess_deviceRequestPromptedEvent,
  "Preload_ruleSetUpdated": Preload_ruleSetUpdatedEvent,
  "Preload_ruleSetRemoved": Preload_ruleSetRemovedEvent,
  "Preload_prerenderAttemptCompleted": Preload_prerenderAttemptCompletedEvent,
  "Preload_preloadEnabledStateUpdated": Preload_preloadEnabledStateUpdatedEvent,
  "Preload_prefetchStatusUpdated": Preload_prefetchStatusUpdatedEvent,
  "Preload_prerenderStatusUpdated": Preload_prerenderStatusUpdatedEvent,
  "Preload_preloadingAttemptSourcesUpdated":
    Preload_preloadingAttemptSourcesUpdatedEvent,
  "FedCm_dialogShown": FedCm_dialogShownEvent,
  "Console_messageAdded": Console_messageAddedEvent,
  "Debugger_breakpointResolved": Debugger_breakpointResolvedEvent,
  "Debugger_paused": Debugger_pausedEvent,
  "Debugger_resumed": Event,
  "Debugger_scriptFailedToParse": Debugger_scriptFailedToParseEvent,
  "Debugger_scriptParsed": Debugger_scriptParsedEvent,
  "HeapProfiler_addHeapSnapshotChunk": HeapProfiler_addHeapSnapshotChunkEvent,
  "HeapProfiler_heapStatsUpdate": HeapProfiler_heapStatsUpdateEvent,
  "HeapProfiler_lastSeenObjectId": HeapProfiler_lastSeenObjectIdEvent,
  "HeapProfiler_reportHeapSnapshotProgress":
    HeapProfiler_reportHeapSnapshotProgressEvent,
  "HeapProfiler_resetProfiles": Event,
  "Profiler_consoleProfileFinished": Profiler_consoleProfileFinishedEvent,
  "Profiler_consoleProfileStarted": Profiler_consoleProfileStartedEvent,
  "Profiler_preciseCoverageDeltaUpdate":
    Profiler_preciseCoverageDeltaUpdateEvent,
  "Runtime_bindingCalled": Runtime_bindingCalledEvent,
  "Runtime_consoleAPICalled": Runtime_consoleAPICalledEvent,
  "Runtime_exceptionRevoked": Runtime_exceptionRevokedEvent,
  "Runtime_exceptionThrown": Runtime_exceptionThrownEvent,
  "Runtime_executionContextCreated": Runtime_executionContextCreatedEvent,
  "Runtime_executionContextDestroyed": Runtime_executionContextDestroyedEvent,
  "Runtime_executionContextsCleared": Event,
  "Runtime_inspectRequested": Runtime_inspectRequestedEvent,
};
...
export class Celestial extends EventTarget {
  ...
  constructor(ws: WebSocket) {
    ...
    this.#ws.onmessage = (e) => {
      ...
      if (handler) {
        ...
        const className = CelestialEvents[
          data.method.replaceAll(".", "_") as keyof CelestialEventMap
        ];
        if (data.params) {
  ...
  Storage = {
    ...
    ): Promise<{ details: Storage_InterestGroupDetails }> => {
